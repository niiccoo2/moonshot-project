<script lang="ts">
    ...
    function processResults(result: any) {
        ...
        if (!leftHip.visibility || !rightHip.visibility || leftHip.visibility < minConfidence || rightHip.visibility < minConfidence) {
            return;
        }
...
<div id="game-root">
    <Game {input} />
    <video bind:this={video} autoplay playsinline muted style="transform: scaleX(-1);" class="video-overlay"></video>
</div>